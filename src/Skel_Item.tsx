        ...
        <CartItems>
          <CartItem key={1}>
            ...
            <ItemInfo>
              ...
              <div>
                <button className="bg-slate-200 rounded-l-lg px-4 h-12 ">
                  {' '}
                </button>
                <span className="mx-4 text-black dark:text-gray-400"> </span>
                <button className="bg-slate-200 rounded-r-lg px-4 h-12 ">
                  {' '}
                </button>
              </div>
            </ItemInfo>
    ...
    return (
      <div className="flex flex-wrap justify-center">
        {sample.map((i) => (
          <div
            key={i}
            className="w-full md:w-1/3 lg:w-1/5 m-2 shrink-0 border dark:border-none rounded-lg"
          >
